...
int main(void)
{
    ...
    GLFWwindow *window = glfwCreateWindow( 800, 600, "Texture2D Test", nullptr, nullptr );
    if ( window == nullptr )
        return 0;
    ...
    unsigned char *data = stbi_load("E:/Project/tinyCAD/res/test.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
